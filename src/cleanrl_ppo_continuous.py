...
if __name__ == "__main__":
    ...
    if args.env_id in ["IMANOCartpoleEnv", "IMANSCartpoleEnv"]:
        model_path = os.path.join(
            "data",
            "policies",
            args.env_id,
            "mod_corr_noise_" + str(int(args.env_noise_corr[0])) + str(int(args.env_noise_corr[1])) + "_mod_noise_std_" + str(args.env_noise_std).replace('.', ''),
